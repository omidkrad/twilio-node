...
describe('SharedCost', function() {
  ...
  it('should generate valid list request',
    function() {
      ...
      var url = _.template('https://api.twilio.com/2010-04-01/Accounts/<%= accountSid %>/AvailablePhoneNumbers/<%= countryCode %>/SharedCost.json')(solution);
