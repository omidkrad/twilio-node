...
WorkspaceList = class WorkspaceList {
   ...
   * @param {string} [opts.eventsFilter] - The events_filter
   * @param {boolean} [opts.multiTaskEnabled] - The multi_task_enabled
 ...
 * @property {string} eventsFilter - The events_filter
 * @property {string} friendlyName - The friendly_name
 * @property {boolean} multiTaskEnabled - The multi_task_enabled
