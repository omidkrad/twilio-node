...
ReservationList = class ReservationList {
  constructor(public version, public workspaceSid, public taskSid) {
  /* jshint ignore:start */
  /**
  ...
  // Path Solution
  static _solution = {workspaceSid: workspaceSid, taskSid: taskSid};
 ...
 * @param {boolean} [opts.callAccept] - The call_accept
