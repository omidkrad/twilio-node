...
ParticipantList = class ParticipantList {
  constructor(public version, public accountSid, public conferenceSid) {
  /* jshint ignore:start */
  /**
  ...
  // Path Solution
  static _solution = {accountSid: accountSid, conferenceSid: conferenceSid};
   ...
   * @param {boolean} [opts.hold] - The hold
 ...
 * @property {boolean} hold - The hold
