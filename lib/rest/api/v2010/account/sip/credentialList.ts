...
import CredentialList = require('./credentialList/credential').CredentialList;
...
Object.defineProperty(CredentialListContext.prototype,
  ...
  get: function() {
    if (!this._credentials) {
      this._credentials = new CredentialList(this._version, this._solution.accountSid, this._solution.sid);
    }
