...
ParticipantList = class ParticipantList {
   ...
   * @param {string} [opts.proxyIdentifierSid] - Proxy Identifier Sid.
 ...
 * @property {string} proxyIdentifier - The proxy_identifier
 * @property {string} proxyIdentifierSid - Proxy Identifier Sid.
 * @property {Date} dateDeleted - The date this Participant was deleted
