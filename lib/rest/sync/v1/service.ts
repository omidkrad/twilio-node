...
import DocumentList = require('./service/document').DocumentList;
import Page = require('../../../base/Page');  /* jshint ignore:line */
import SyncListList = require('./service/syncList').SyncListList;
import SyncMapList = require('./service/syncMap').SyncMapList;
import SyncStreamList = require('./service/syncStream').SyncStreamList;
