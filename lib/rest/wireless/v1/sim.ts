...
import DataSessionList = require('./sim/dataSession').DataSessionList;
import Page = require('../../../base/Page');  /* jshint ignore:line */
import UsageRecordList = require('./sim/usageRecord').UsageRecordList;
...
SimList = class SimList {
   ...
   * @param {sim.status} [opts.status] - The status
 ...
 * @property {sim.status} status - The status
