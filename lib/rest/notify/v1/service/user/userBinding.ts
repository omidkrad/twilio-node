 ...
 */
/* jshint ignore:end */
UserBindingList = function UserBindingList(version, serviceSid, identity) {
  /* jshint ignore:start */
  /**
   * @function bindings
 ...
 */
/* jshint ignore:end */
UserBindingContext = function UserBindingContext(version, serviceSid, identity,
                                                  sid) {
  this._version = version;
  ...
  this._uri = _.template(
    '/Services/<%= serviceSid %>/Users/<%= identity %>/Bindings/<%= sid %>' // jshint ignore:line
  )(this._solution);
};
