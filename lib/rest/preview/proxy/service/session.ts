...
import InteractionList = require('./session/interaction').InteractionList;
import Page = require('../../../../base/Page');  /* jshint ignore:line */
import ParticipantList = require('./session/participant').ParticipantList;
...
/* jshint ignore:start */
/**
 * @constructor Twilio.Preview.Proxy.ServiceContext.SessionList
...
SessionList = class SessionList {
   ...
   * @param {string} [opts.uniqueName] -
   *          A unique, developer assigned name of this Session.
   * @param {number} [opts.ttl] - How long will this session stay open, in seconds.
   * @param {session.status} [opts.status] - The Status of this Session
  ...
  static create(opts, callback) {
    ...
    var data = values.of({
      ...
      'Ttl': _.get(opts, 'ttl'),
      'Status': _.get(opts, 'status'),
      'Participants': serialize.map(_.get(opts, 'participants'), function(e) { return e; })
    });
 ...
 *          A unique, developer assigned name of this Session.
 * @property {number} ttl - How long will this session stay open, in seconds.
 * @property {session.status} status - The Status of this Session
 * @property {Date} startTime - The date this Session was started
 * @property {Date} endTime - The date this Session was ended
 * @property {Date} dateCreated - The date this Session was created
 * @property {Date} dateUpdated - The date this Session was updated
 * @property {string} url - The URL of this Session.
 ...
 * PLEASE NOTE that this class contains preview products that are subject to change. Use them with caution. If you currently do not have developer preview access, please contact help@twilio.com.
 *
 * @property {Twilio.Preview.Proxy.ServiceContext.SessionContext.InteractionList} interactions -
 *          interactions resource
 * @property {Twilio.Preview.Proxy.ServiceContext.SessionContext.ParticipantList} participants -
