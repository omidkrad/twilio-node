...
/* jshint ignore:start */
/**
 * @constructor Twilio.Preview.Proxy.ServiceContext.PhoneNumberList
...
PhoneNumberList = function PhoneNumberList(version, serviceSid) {
   ...
   *
   * @returns {Twilio.Preview.Proxy.ServiceContext.PhoneNumberContext}
   */
  /* jshint ignore:end */
 ...
 * @param {sid} sid - Fetch by unique phone-number Sid
 */
/* jshint ignore:end */
