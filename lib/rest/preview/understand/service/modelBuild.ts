...
/* jshint ignore:start */
/**
 * @constructor Twilio.Preview.Understand.ServiceContext.ModelBuildList
...
ModelBuildList = class ModelBuildList {
   ...
   *
   * @function each
   * @memberof Twilio.Preview.Understand.ServiceContext.ModelBuildList
   * @instance
   *
...
/* jshint ignore:start */
/**
 * @constructor Twilio.Preview.Understand.ServiceContext.ModelBuildPage
 * @augments Page
 ...
 * @memberof Twilio.Preview.Understand.ServiceContext.ModelBuildPage
 * @instance
 *
...
/* jshint ignore:start */
/**
 * @constructor Twilio.Preview.Understand.ServiceContext.ModelBuildInstance
 ...
 * @property {model_build.status} status - The status
 ...
 */
/* jshint ignore:end */
ModelBuildInstance = function ModelBuildInstance(version, payload, serviceSid,
                                                  sid) {
...
Object.defineProperty(ModelBuildInstance.prototype,
  ...
  get: function() {
    if (!this._context) {
      this._context = new ModelBuildContext(this._version, this._solution.serviceSid, this._solution.sid);
    }
 ...
 *
 * @function fetch
 * @memberof Twilio.Preview.Understand.ServiceContext.ModelBuildInstance
 * @instance
 *
 * @param {function} [callback] - Callback to handle processed record
 *
...
/* jshint ignore:start */
/**
 * @constructor Twilio.Preview.Understand.ServiceContext.ModelBuildContext
 * @description Initialize the ModelBuildContext
 * PLEASE NOTE that this class contains preview products that are subject to change. Use them with caution. If you currently do not have developer preview access, please contact help@twilio.com.
 *
 * @param {Twilio.Preview.Understand} version - Version of the resource
...
ModelBuildContext = class ModelBuildContext {
  ...
  this._uri = _.template(
    '/Services/<%= serviceSid %>/ModelBuilds/<%= sid %>' // jshint ignore:line
  )(this._solution);
};
 ...
 *
 * @function fetch
 * @memberof Twilio.Preview.Understand.ServiceContext.ModelBuildContext
 * @instance
 *
 * @param {function} [callback] - Callback to handle processed record
 *
